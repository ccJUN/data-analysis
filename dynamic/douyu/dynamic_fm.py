...
def get_dm(cfd,uid):
    ...
    while True:
	    ...
	    dcapi = 'dc04729'
	    dctype = 0
	    dccontent = 'plat_id=douyu&maintype=fm233&roomid='+str(room_id)+'&content='+str(txt).encode('utf-8')+'&user_name='+str(nn).encode('utf-8')+'&user_id='+str(uid)
        ...
        for uid, nn, level, nl in pattern2.findall(buffer):
            ...
            dctype = 0
#	    print(room_id)
            dccontent = 'plat_id=douyu&maintype=fm233&roomid='+str(room_id)+'&user_name='+str(nn).encode('utf-8')+'&user_id='+str(uid)
            logger = CLogger()
	    ...
	    cost = int(coast)
            dccontent ='plat=douyu&maintype=fm233&gift_name='+str(giftname).encode('utf-8')+'&cost='+str(cost)+'&plat_id=11&roomid='+str(room_id)+'&gift_id='+str(gfid).encode('utf-8')+'&gift_num='+gfcnt+'&user_name='+str(nn).encode('utf-8')+'&user_id='+str(uid)+'&combo_num='+str(hits)
